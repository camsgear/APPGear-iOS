 ...
 */
+ (nullable instancetype)cl_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)cl_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)cl_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)cl_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)cl_modelToJSONObject;
 ...
 */
- (nullable NSData *)cl_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)cl_modelToJSONString;
 ...
 */
- (void)cl_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)cl_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)cl_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
+ (nullable NSDictionary *)cl_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
